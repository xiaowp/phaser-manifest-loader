...
var AssetLoader = function (_Phaser$Plugin) {
  ...
  _createClass(AssetLoader, [{
    ...
    value: function loadManifest(manifest) {
      ...
      return new Promise(function (resolve) {
        Object.keys(_this2.loaders).forEach(function (assetType) {
          ...
          if (!assets) return;
          assets.forEach(function (assetOpt) {
            _this2.loaders[assetType].call(_this2, assetOpt, assetPostfix);
          });
        });
    ...
    key: 'loadSpriteSheet',
    value: function loadSpriteSheet(opt, assetPostfix) {
      var imageUrl = void 0,
          json = void 0;
    ...
    value: function loadAtlasJSONArray(opt, assetPostfix) {
      var imageUrl = void 0,
          json = void 0;
      ...
      this.game.load.atlasJSONArray(alias, imageUrl, (0, _isString2.default)(json) && json, (0, _isObject2.default)(json) && json);
    }
  }, {
    key: 'loadImage',
    value: function loadImage(opt, assetPostfix) {
      var urls = [];
    ...
    key: 'loadVideo',
    value: function loadVideo(opt, assetPostfix) {
      var urls = [];
    ...
    key: 'loadBitmapFont',
    value: function loadBitmapFont(opt, assetPostfix) {
      var key = void 0,
          alias = void 0;
      if (typeof opt === 'string') {
        key = opt;
